	...
	//echo 'window.alert("entro en update Empresa")';
		...
		if($pass!="" and $pass2!=""){
				...
				if(0!=strcmp($pass,$pass2)){
					...
					echo '</script>';
					echo '<script language="javascript">';
					echo 'window.location.href = "http://localhost/meeze/empresa/empresaPerfil.php"';//hacer bien el redirecrionamiento
					echo '</script>';
				}
				else{
				$pass= md5($pass);
			...
			echo '<script language="javascript">';
			echo 'window.location.href = "http://localhost/meeze/empresa/empresaPerfil.php"';
			echo '</script>';
